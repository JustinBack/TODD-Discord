...
module.exports = {
    ...
    execute: (message: messageObj, bot: Client) => {
        const embed = new MessageEmbed()
            ...
            .addField("Phoenix Crawler (crawler.tosdr.org)", "[Report a bug](https://github.com/tosdr/crawler.tosdr.org/issues/new?labels=bug)\n[Suggest a feature](https://github.com/tosdr/crawler.tosdr.org/discussions/new?category=ideas)")
            .addField("Browser Extensions", "[Report a general bug](https://github.com/tosdr/browser-extensions/issues/new?labels=bug)\n---\n[Report a bug for Firefox](https://github.com/tosdr/browser-extensions/issues/new?assignees=&labels=bug,firefox&template=mozilla-firefox.md&title=)\n[Report a bug for Edge](https://github.com/tosdr/browser-extensions/issues/new?assignees=&labels=bug,edge&template=microsoft-edge.md&title=)\n[Report a bug for Opera](https://github.com/tosdr/browser-extensions/issues/new?assignees=&labels=bug%2C+opera&template=opera.md&title=)\n[Report a bug for Chrome](https://github.com/tosdr/browser-extensions/issues/new?assignees=&labels=bug%2C+chrome&template=google-chrome.md&title=)\n[Report a bug for Safari](https://github.com/tosdr/browser-extensions/issues/new?assignees=&labels=bug%2C+safari&template=safari.md&title=)\n---\n[Suggest a feature](https://github.com/tosdr/browser-extensions/discussions/new?category=ideas)")
